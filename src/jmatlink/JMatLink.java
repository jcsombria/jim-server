    ...
    ***************************************************************************/
     ...
     ***************************************************************************/
     ...
     public Image engGetFigure(long epI, int figure, int dx, int dy)
     {
         ...
         String imageFileS = tmpDirS + "jmatlink" + figure + "_" + randomInt + ".png";
         ...
         engEvalString(epI,"print("+ figure +",'-dpng','-r100','" +imageFileS+ "')"); //Gonzalo 070509
     ...
     public Image engGetFigure(int figure, int dx, int dy)
     {
         ...
         engEvalString("print("+ figure +",'-dpng','-r100','" +imageFileS+ "')"); //Gonzalo 070509
